...
- [Devoxx][y1]: Devoxx 的频道，其中有各种很不错的技术分享。
- [Coding Tech][y2]: 也是个非常不错的编程频道，涵盖各种技术。
- [Amazon Web Services][y3]
- [Facebook Developers][y4]
- [Google Developer][y5]: Google 公司的官方频道，其中包括 Google I/O 大会、教程、新闻、最佳实践、技巧分享……
- [Spring Developer][y6]: Spring 的官方频道。
- [Microsoft Research][y7]
- [MIT 公开课][y8]
- [Stanford Online][y9]
- [Prof. Dr. Jens Dittrich][y10]: 一个德国教授开的一个关于数据库相关的频道，里面有很不错的数据库内在原理的内容。
- [Red Hat Summit][y11]: RedHat 峰会频道，其中有很多和 Linux 相关的技术新闻和分享。
- [Open Networking Summit][y12]: 这是一个网络相关的频道。
- [Dan Van Boxel][y13]: 这是一个机器学习工程师折腾各种事的视频，挺有意思的。
- [The New Boston][y14]: 这个频道应该是前端开发工程师必去的地方，可能也是我所知道的最好的关于前端技术的 YouTube 频道。
- [Derek Banas 是一个教程型的频][y15]: 其中包括编程语言、游戏开发、Web 开发……我个人觉得是一个可以用来练英文听力的频道。
- [Java][y16]: Java 相关的各种分享。
- [CppCon][y17]: C++ 大会的一些视频，可以让你了解很多 C++ 最新功能和相关的动态。
- [Computerphile][y18]: 这个频道是布雷迪·哈伦（Brady Haran）运作的几个频道中的一个
  - 在这个频道里你可以看到很多很有趣的技术方面的科普教程、资讯、见闻等，说得都非常地简单易懂，所以有大量的订阅用户。
  - 布雷迪是个对任何技术都很有热情的人，这个频道是关于计算机技术的。
  - 除此之外，他还运作 [Numberphile（数学）][y23]、[Periodic Videos（化学）][y24]、[Sixty Symbols（物理）][y25]、[Deep Sky Videos（天文）][y26]等有众多阅人数的频道。
  - 如果你喜欢，你都可以一一订阅，感觉就是一个个人版的 Discovery。
- 关于安全，有如下四个频道你可以订阅一下：
  - [DEFCONConference][y19]: defcon.org 的官方频道。
  - [CCCen][y20]: Chaos Computer Club。
  - [RSA Conference][y21]: RSA Conference。
  - [Black Hat][y22]: Black Hat Conference。

#### 各大公司技术博客

- [Airbnb Engineering][c1]
- AWS 相关
  - [All Things Distributed][c2]
  - [AWS Architecture Blog][c3]
  - [On Efficiency, Reliability, Scaling - James Hamilton, VP at AWS][c4]
- [Bandcamp Tech][c5]
- [BankSimple Simple Blog][c6] （翻墙访问不了）
- [Bitly Engineering Blog][c7] （2018年以后没有更新了）
- [Cloudera Developer Blog][c8]
- [Dropbox Tech Blog][c9]
- [Etsy Code as Craft][c10]
- [Facebook Engineering][c11] （需要登录）
- [Flickr Code][c12]
- [Foursquare Engineering Blog][c13]
- [Google Research Blog][c14]
- [Groupn Engineering Blog][c15]
- [High Scalability][c16]
- [Instagram Engineering][c17]
- [LinkedIn Engineering][c18]
- [Oyster Tech Blog][c19]
- [Pinterest Engineering Blog][c20]
- [Quora Engineering][c21]
- [Songkick Technology Blog][c22]
- [SoundCloud Backstage Blog][c23]
- [Square The Corner][c24]
- [The Reddit Blog][c25]
- [The GitHub Blog][c26]
- [The Netflix Tech Blog][c27]
- [Twilio Engineering Blog][c28]
- [Twitter Engineering][c29]
- [Yelp Engineering Blog][c30]
- [Smarkets Blog][c31]
